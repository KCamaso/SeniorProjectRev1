...
public class MedicineDialog extends AppCompatDialogFragment {
    private EditText hourText;
    private EditText minuteText;
    private CheckBox[] weekBoxes;
    private TimeDialog.TimeDialogueListener listener;
    @Override
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());

        LayoutInflater inflater = getActivity().getLayoutInflater();
        View view = inflater.inflate(R.layout.layout_dialogue_medicine, null);
    ...
    public interface  MedicineDialogueListener
    {
